...
using ApplicationBase =
    goby::zeromq::SingleThreadApplication<goby3_course::config::MyHelm>;

namespace goby3_course
{
namespace apps
{
class MyHelm : public ApplicationBase
{
  public:
    MyHelm();
...
{
    return goby::run<goby3_course::apps::MyHelm>(
        goby::middleware::ProtobufConfigurator<goby3_course::config::MyHelm>(argc, argv));
}

goby3_course::apps::MyHelm::MyHelm() : ApplicationBase(1.0 * boost::units::si::hertz) {
...
void goby3_course::apps::MyHelm::publisher()
{
    ...
    goby::middleware::frontseat::protobuf::HelmStateReport my_helm_state;
    my_helm_state.set_state(goby::middleware::frontseat::protobuf::HELM_DRIVE);
    glog.is_verbose() && glog << "Publishing Helm_Drive: " << my_helm_state.ShortDebugString() << std::endl;
    interprocess().publish<goby::middleware::frontseat::groups::helm_state>(my_helm_state);
...
void goby3_course::apps::MyHelm::update_leg()
{
...
void goby3_course::apps::MyHelm::send_auv_command()
{
    ...
    glog.is_verbose() && glog << "Would send AUV recovery command here";
}
